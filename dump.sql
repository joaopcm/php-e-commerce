...
INSERT INTO `tb_addresses` VALUES (1,1,'Rua Caetano Pero Neto',NULL,'Ṣo Paulo','SP','Brasil','03917050','Jardim Porteira Grande','2018-12-23 23:46:46'),(2,1,'Rua Caetano Pero Neto',NULL,'Ṣo Paulo','SP','Brasil','03917050','Jardim Porteira Grande','2018-12-24 16:13:56'),(3,1,'Rua Caetano Pero Neto',NULL,'Ṣo Paulo','SP','Brasil','03917050','Jardim Porteira Grande','2018-12-24 16:14:09'),(4,1,'Rua Caetano Pero Neto',NULL,'Ṣo Paulo','SP','Brasil','03917050','Jardim Porteira Grande','2018-12-24 16:14:19'),(5,1,'Rua Caetano Pero Neto',NULL,'Ṣo Paulo','SP','Brasil','03917050','Jardim Porteira Grande','2018-12-24 16:19:31'),(6,1,'Rua Caetano Pero Neto',NULL,'Ṣo Paulo','SP','Brasil','03917050','Jardim Porteira Grande','2018-12-24 16:19:54'),(7,1,'Rua Caetano Pero Neto',NULL,'Ṣo Paulo','SP','Brasil','03917050','Jardim Porteira Grande','2018-12-24 16:20:52'),(8,1,'Rua Caetano Pero Neto',NULL,'Ṣo Paulo','SP','Brasil','03917050','Jardim Porteira Grande','2018-12-24 16:23:46'),(9,1,'Rua Caetano Pero Neto',NULL,'Ṣo Paulo','SP','Brasil','03917050','Jardim Porteira Grande','2018-12-24 16:25:06'),(10,1,'Rua Caetano Pero Neto',NULL,'Ṣo Paulo','SP','Brasil','03917050','Jardim Porteira Grande','2018-12-24 16:36:21'),(11,1,'Rua Caetano Pero Neto',NULL,'Ṣo Paulo','SP','Brasil','03917050','Jardim Porteira Grande','2018-12-24 16:39:14'),(12,1,'Rua Caetano Pero Neto',NULL,'Ṣo Paulo','SP','Brasil','03917050','Jardim Porteira Grande','2018-12-24 16:59:23'),(13,1,'Rua Caetano Pero Neto',NULL,'Ṣo Paulo','SP','Brasil','03917050','Jardim Porteira Grande','2018-12-24 17:02:40');
...
INSERT INTO `tb_carts` VALUES (1,'d90c14b2f83cfc202c19e458469147b3',1,'03917050',73.71,4,'2018-12-23 23:09:34'),(2,'eae835ba27cf0c54eea1fc8ec8174829',1,'03917050',174.66,4,'2018-12-24 15:56:53');
...
INSERT INTO `tb_cartsproducts` VALUES (3,2,12,NULL,'2018-12-24 16:12:54'),(4,2,12,NULL,'2018-12-24 16:12:54');
...
INSERT INTO `tb_categories` VALUES (10,'Celulares','2018-12-24 16:02:07');
...
INSERT INTO `tb_orders` VALUES (1,2,1,1,13,3174.66,'2018-12-24 17:02:40');
...
INSERT INTO `tb_ordersstatus` VALUES (1,'Em Aberto','2018-12-24 00:00:00'),(2,'Aguardando Pagamento','2018-12-24 00:00:00'),(3,'Pago','2018-12-24 00:00:00'),(4,'Entregue','2018-12-24 00:00:00');
...
INSERT INTO `tb_persons` VALUES (1,'Jọo Pedro da Cruz Melo','joao.pedro6532@gmail.com',11963005537,'2018-12-22 22:24:47');
...
CREATE TABLE `tb_products` (
  ...
  `deslitledescription` varchar(64) NOT NULL,
  `desdescription` varchar(512) NOT NULL,
...
INSERT INTO `tb_products` VALUES (12,'Produto de teste',1500.00,6.00,12.00,0.40,0.30,'Pequena descri̤̣o.','Descri̤̣o avan̤ada.','produto-de-teste','2018-12-24 16:02:51');
...
INSERT INTO `tb_productscategories` VALUES (10,12);
...
INSERT INTO `tb_users` VALUES (1,1,'joao.pedro6532@gmail.com','$2y$12$7hgwU9zhBGE8aTyEE1i2EuiAmtGr8Re27Ys4g1mwFSvBAMNkxhFvq',1,'2018-12-22 22:24:47');
...
INSERT INTO `tb_userspasswordsrecoveries` VALUES (1,1,'172.22.0.1','2018-12-23 19:19:07','2018-12-23 19:18:49'),(2,1,'172.26.0.1','2018-12-24 15:56:34','2018-12-24 15:56:10');
...
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_addresses_save`(
pidaddress int(11), 
pidperson int(11),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_carts_save`(
pidcart INT,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_categories_save`(
pidcategory INT,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_orders_save`(
pidorder INT,
pidcart int(11),
piduser int(11),
pidstatus int(11),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_products_save`(
pidproduct int(11),
...
pdeslitledescription varchar(64),
pdesdescription varchar(512),
pdesurl varchar(128)
)
BEGIN
	...
	IF pidproduct > 0 THEN
        ...
        SET 
            ...
            vllength = pvllength,
            vlweight = pvlweight,
            deslitledescription = pdeslitledescription,
    ...
    ELSE
		...
		INSERT INTO tb_products (desproduct, vlprice, vlwidth, vlheight, vllength, vlweight, deslitledescription, desdescription, desurl) 
        VALUES(pdesproduct, pvlprice, pvlwidth, pvlheight, pvllength, pvlweight, pdeslitledescription, pdesdescription, pdesurl);
...
BEGIN
 ...
 SELECT idperson INTO vidperson
    ...
    DELETE FROM tb_carts WHERE iduser = vidperson;
...
-- Dump completed on 2018-12-24 15:37:30
