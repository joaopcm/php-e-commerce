...
INSERT INTO `tb_categories` VALUES (1,'Categoria 1','2018-12-27 01:36:25');
...
INSERT INTO `tb_company` VALUES (1,'Loja Virtual','Sua loja virtual dos sonhos','Rua Caetano Pero Neto, 141','Jardim Porteira Grande','Ṣo Paulo','SP','03917050',1121540597,'contato@lojavirtual.com.br','17.493.842/0001-25');
...
INSERT INTO `tb_persons` VALUES (1,'Administrador','joao.pedro6532@gmail.com',0,'2018-12-27 01:27:07');
...
INSERT INTO `tb_users` VALUES (1,1,'admin','$2y$12$/S1PCOfUGL9H9lQJ.ewhAulZtimWyWQuq114aNl5Gg/wxN5xxu61i',1,'2018-12-27 01:27:07');
...
/*!50003 SET collation_connection  = @saved_col_connection */ ;
ALTER DATABASE `db_ecommerce` CHARACTER SET utf8 COLLATE utf8_general_ci ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_company_save` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_company_save`(
pidcompany INT,
pdescompany VARCHAR(64),
pdesslogan VARCHAR(256),
...
BEGIN
	...
	UPDATE tb_company
	SET
		descompany = pdescompany,
		desslogan = pdesslogan,
		desaddress = pdesaddress,
		desdistrict = pdesdistrict,
		descity = pdescity,
		desstate = pdesstate,
		...
		desemail = pdesemail,
		descnpj = pdescnpj
	WHERE idcompany = pidcompany;
    
    SELECT * FROM tb_company WHERE idcompany = pidcompany;
...
BEGIN
	...
	IF pidorder > 0 THEN
        ...
        SET
            ...
            dtpayment = ppaymentdate
		WHERE idorder = pidorder;
        
    ELSE
    
		INSERT INTO tb_orders (idcart, iduser, idstatus, idaddress, vltotal, paymentMethod)
        VALUES(pidcart, piduser, pidstatus, pidaddress, pvltotal, ppaymentMethod);
...
-- Dump completed on 2018-12-27  0:05:52
